...
#[Fillable(['name', 'email', 'password', 'office_id', 'branch_id', 'department_id', 'designation_id', 'employee_id', 'phone', 'nid', 'blood_group', 'present_address', 'permanent_address', 'photo_path', 'status'])]
