...
<div class="max-w-3xl mx-auto space-y-8">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-3xl font-bold tracking-tight text-white">Register Project Land</h2>
            <p class="text-sm text-slate-400 mt-1">Register land details and deeds associated with an NHA project.</p>
        </div>
    ...
    <div class="p-8 rounded-2xl bg-[#0E1325]/80 border border-slate-800/80 shadow-xl">
        <form action="{{ route('property.lands.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="date" name="purchase_date" id="purchase_date" required value="{{ old('purchase_date') }}" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="date" name="registration_date" id="registration_date" required value="{{ old('registration_date') }}" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="number" step="0.01" name="purchase_value" id="purchase_value" required value="{{ old('purchase_value') }}" placeholder="e.g. 5000000.00" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>

                <!-- Land Amount -->
                <div class="space-y-1.5">
                    <label for="land_amount" class="block text-xs font-semibold text-slate-400 uppercase tracking-wider">Land Amount (Acres) *</label>
                    <input type="number" step="0.01" name="land_amount" id="land_amount" required value="{{ old('land_amount') }}" placeholder="e.g. 2.45" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="deed_number" id="deed_number" required value="{{ old('deed_number') }}" placeholder="e.g. DEED-4432" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="land_classification" id="land_classification" required value="{{ old('land_classification') }}" placeholder="e.g. Residential Flat Land" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="khatian_number" id="khatian_number" required value="{{ old('khatian_number') }}" placeholder="e.g. CS-12, RS-45" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>

                <!-- Dag Number -->
                <div class="space-y-1.5">
                    <label for="dag_number" class="block text-xs font-semibold text-slate-400 uppercase tracking-wider">Dag Number *</label>
                    <input type="text" name="dag_number" id="dag_number" required value="{{ old('dag_number') }}" placeholder="e.g. DAG-101, 102" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" name="seller_information" id="seller_information" required value="{{ old('seller_information') }}" placeholder="e.g. Uttara Land Developers Ltd." class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <p class="text-[10px] text-slate-500">Allowed formats: PDF, JPG, JPEG, PNG (Max size: 5MB)</p>
            </div>
