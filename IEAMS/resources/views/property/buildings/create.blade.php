...
<div class="max-w-3xl mx-auto space-y-8">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-3xl font-bold tracking-tight text-white">Add Building to Plot</h2>
            <p class="text-sm text-slate-400 mt-1">Register a building structure on a selected project plot specification.</p>
        </div>
    ...
    <div class="p-8 rounded-2xl bg-[#0E1325]/80 border border-slate-800/80 shadow-xl">
        <form action="{{ route('property.buildings.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="name" id="name" required value="{{ old('name') }}" placeholder="e.g. NHA Heights Tower A" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>

                <!-- Building Number -->
                <div class="space-y-1.5">
                    <label for="number" class="block text-xs font-semibold text-slate-400 uppercase tracking-wider">Building Number/Code *</label>
                    <input type="text" name="number" id="number" required value="{{ old('number') }}" placeholder="e.g. BLDG-01" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="number" step="0.01" name="footprint_area" id="footprint_area" required value="{{ old('footprint_area') }}" placeholder="e.g. 3000.00" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>

                <!-- Total Floor -->
                <div class="space-y-1.5">
                    <label for="total_floor" class="block text-xs font-semibold text-slate-400 uppercase tracking-wider">Total Floors *</label>
                    <input type="number" name="total_floor" id="total_floor" required value="{{ old('total_floor') }}" placeholder="e.g. 10" class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="p-4 rounded-xl bg-[#080B11] border border-slate-800/80 flex items-start">
                        <div class="flex items-center h-5">
                            <input type="checkbox" name="has_lift" value="1" id="has_lift" class="w-4 h-4 text-indigo-600 bg-slate-900 border-slate-700 rounded focus:ring-indigo-500" {{ old('has_lift') ? 'checked' : '' }}>
                        </div>
                    ...
                    <div class="p-4 rounded-xl bg-[#080B11] border border-slate-800/80 flex items-start">
                        <div class="flex items-center h-5">
                            <input type="checkbox" name="has_parking" value="1" id="has_parking" class="w-4 h-4 text-indigo-600 bg-slate-900 border-slate-700 rounded focus:ring-indigo-500" {{ old('has_parking') ? 'checked' : '' }}>
                        </div>
                        <div class="ml-3 text-sm">
            ...
            <div class="space-y-1.5">
                ...
                <select name="construction_status" id="construction_status" required class="w-full bg-[#080B11] border border-slate-700/80 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition">
                    <option value="planned" {{ old('construction_status') == 'planned' ? 'selected' : '' }}>Planned</option>
